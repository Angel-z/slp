...
import com.kanofans.common.utils.poi.ExcelUtil;
...
import com.kanofans.project.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
     ...
     * 根据用户编号获取用户昵称
     */
    @GetMapping("/nameById/{userId}")
    public AjaxResult getUserName(@PathVariable(value = "userId") Long userId)
    {
        AjaxResult ajax = AjaxResult.success();
        SysUser sysUser = userService.selectUserById(userId);
        ajax.put("userName", sysUser.getNickName());
        return ajax;
    }
    ...
    {
        AjaxResult ajax = AjaxResult.success();
        SlpUserPublicInfo slpUserPublicInfo = userService.selectUserPublicInfoById(userId);
        ajax.put(AjaxResult.DATA_TAG, slpUserPublicInfo);
        return ajax;
    }
